...
class RandomDELPHIData:
    ...
    def __init__(
            ...
            hospitalization_prob_range: Tuple[float, float] = (1e-3, 0.3),
            death_prob_range: Tuple[float, float] = (5e-3, 0.1),
    ...
    def _generate_parameters(self) -> Dict[str, Union[float, np.ndarray]]:
        ...
        return {
            ...
            "iur_transition_rate": detection_rate * (1 - self.detection_prob) * (1 - self.death_prob),
